...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [Reservation] ADD CONSTRAINT [Reservation_FPerson_0] FOREIGN KEY ([Person_m0]) REFERENCES [Person]
CREATE INDEX Reservation_IPerson_m0 on [Reservation] ([Person_m0])

 ALTER TABLE [Reservation] ADD CONSTRAINT [Reservation_FRoom_0] FOREIGN KEY ([Room_m0]) REFERENCES [Room]
CREATE INDEX Reservation_IRoom_m0 on [Reservation] ([Room_m0])
